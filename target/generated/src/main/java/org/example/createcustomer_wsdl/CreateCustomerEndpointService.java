...
public class CreateCustomerEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/rakesh/workspace/webServiceExpose/src/main/resources/wsdl/GetFullName.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CreateCustomerEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/rakesh/workspace/webServiceExpose/src/main/resources/wsdl/GetFullName.wsdl");
        }
        WSDL_LOCATION = url;
    }
